 ...
 * @author Ajmir
 */
public class PrevSecurityM extends javax.swing.JFrame {
...
//        moneytbl.getColumnModel().getColumn(2).setCellRenderer(new WordWrapCellRenderer());
    ...
    public void settable(int type){
        ...
        switch (type) {
            case 0:
                sql = "select hallid,name,roll,entrydate,securitymoney,messad,idcard,depositdate,withdrawdate,moneystatus from previousstudents ORDER by hallid ";
                
                break;
            case 1:
                sql = "select hallid,name,roll,entrydate,securitymoney,messad,idcard,depositdate,withdrawdate,moneystatus from previousstudents where moneystatus=1";
                
                break;
            case 2:
                sql = "select hallid,name,roll,entrydate,securitymoney,messad,idcard,depositdate,withdrawdate,moneystatus from previousstudents where moneystatus=0";
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Previous Students Security Money View");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CurrentSecurityM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (InstantiationException ex) {
            java.util.logging.Logger.getLogger(CurrentSecurityM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        } catch (IllegalAccessException ex) {
            java.util.logging.Logger.getLogger(CurrentSecurityM.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CurrentSecurityM().setVisible(true);
            }
        });
    }
